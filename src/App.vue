...
function getTop() {
  // state handler
  if (one.getBoundingClientRect().top > 0 && two.getBoundingClientRect().top > height) state.value = 1;
  if (one.getBoundingClientRect().top < 0) state.value = 2;
  if (two.getBoundingClientRect().bottom < height) state.value = 2;
  if (twoA.getBoundingClientRect().bottom < height) state.value = 2.5;
  if (twoB.getBoundingClientRect().bottom < height) state.value = 2.6;
  if (three.getBoundingClientRect().bottom < height) state.value = 3;
  if (four.getBoundingClientRect().bottom < height) state.value = 4;
  if (five.getBoundingClientRect().bottom < height) state.value = 5;
  if (six.getBoundingClientRect().bottom < height) state.value = 6;
}
